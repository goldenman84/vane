...
public class MiniTemplatorCache {
	...
	private HashMap<String, MiniTemplator> cache; // buffered MiniTemplator
													// objects
	 ...
	 */
	public synchronized MiniTemplator get(
			MiniTemplator.TemplateSpecification templateSpec)
